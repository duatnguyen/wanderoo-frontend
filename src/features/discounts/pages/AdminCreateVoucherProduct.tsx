...
const AdminCreateVoucherProduct: React.FC = () => {
  ...
  const isAllSelected = displayProducts.length > 0 && selectedProducts.length === displayProducts.length;
  ...
  return (
    <div className="flex flex-col w-full max-w-[calc(100%-500px)] mx-auto mt-[10px]">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-[16px] w-full mt-[8px]">
        ...
        <div className="bg-white border border-[#e7e7e7] rounded-[24px] p-[24px] flex flex-col gap-[16px] w-full">
          ...
          <div className="px-0 py-[12px] flex flex-col gap-[16px]">
            ...
            <div className="flex flex-col gap-[14px]">
              <div className={`flex flex-col sm:flex-row sm:items-center gap-[8px] sm:gap-[16px] ${confirmedProducts.length > 0 ? 'sm:justify-between' : ''}`}>
                <div className="flex flex-col sm:flex-row sm:items-center gap-[8px]">
                  <label className="font-semibold text-[14px] text-[#272424] leading-[1.4] w-[200px] sm:w-[215px] flex-shrink-0 text-right">
              ...
              {confirmedProducts.length > 0 && (
                <div className="bg-white border border-[#e7e7e7] rounded-[12px] overflow-hidden ml-[200px] sm:ml-[215px] max-w-[calc(100%-200px)] sm:max-w-[calc(100%-215px)] mt-[4px]">
                  <table className="w-full">
                    ...
                    <tbody>
                      {confirmedProducts
                        .slice((appliedProductsPage - 1) * 5, appliedProductsPage * 5)
                        .map((product) => (
                          <tr
                            key={product.id}
                          ...
                          >
                            ...
                            <td className="px-[16px] py-[12px] text-center">
                              <span className="font-semibold text-[14px] text-[#272424]">1</span>
                            </td>
                            <td className="px-[16px] py-[12px] text-center">
                              <button
                                type="button"
        ...
        <div className="flex gap-[16px] justify-end w-full">
          <Button type="button" variant="secondary" onClick={handleBackClick} className="text-[14px]">
            Hủy
          </Button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-[20px] w-full max-w-3xl max-h-[80vh] overflow-hidden flex flex-col z-50">
            ...
            <div className="px-[16px] py-[12px] border-b border-[#e7e7e7]">
              <h2 className="font-bold text-[16px] text-[#272424]">Chọn sản phẩm</h2>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {displayProducts.map((product) => (
                    <tr key={product.id} className="border-b border-[#e7e7e7]">
                        ...
                        <div className="flex items-center gap-[8px]">
                          ...
                          <div className="flex flex-col gap-[2px] min-w-0">
                            ...
                            <span className="font-normal text-[10px] text-[#737373] truncate">
                              Mã barcode: {product.barcode.replace(/^(M3 Barcode:|MS:)\s*/i, "")}
                            </span>
                          </div>
                        </div>
                      </td>
              ...
              <div className="flex items-center justify-center gap-[4px]">
                ...
                <div className="flex items-center gap-[4px]">
                  {getPageNumbers().map((page, index) => {
                    if (page === "...") {
                      return (
                        <span key={`ellipsis-${index}`} className="px-[6px] text-[12px] text-[#272424]">
                          ...
                        </span>
                      );
                    }
                ...
                <button
                  ...
                  className="p-[6px] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#f5f5f5] transition-colors rounded-[6px]"
                >
                  <Icon name="arrow-left" size={14} color="#272424" className="rotate-180" />
                </button>
              </div>

      ...
      <div className="bg-white border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-[#E04D30] transition-colors">
        <div className="flex flex-col items-center justify-center">
          ...
          {onAddNew && (
            <Button
              onClick={onAddNew}
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#E04D30] hover:bg-[#c53b1d] text-white font-semibold rounded-lg transition-colors shadow-md hover:shadow-lg h-auto"
            >
    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button
          variant="link"
          onClick={onChange}
          className="text-sm text-[#E04D30] hover:text-[#c53b1d] font-semibold transition-colors flex items-center gap-1 h-auto p-0 hover:no-underline"
        >

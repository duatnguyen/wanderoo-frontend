...
function FacebookIcon() {
  return (
    ...
    >
      <path
        d="M14 9h3V6h-3a3 3 0 00-3 3v3H8v3h3v6h3v-6h3l1-3h-4V9a1 1 0 011-1z"
        fill="currentColor"
      />
    </svg>
  );
...
const Footer: React.FC = () => {
  return (
    <footer
      className="w-full bg-[#18345c] text-white mt-10"
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-4 text-center text-[14px] font-medium text-white/90">
        WANDEROO chuyên cung cấp đồ cắm trại outdoor camping thể thao ngoài trời
        chính hãng tại Hà Nội
      </div>
    </footer>
  );
};

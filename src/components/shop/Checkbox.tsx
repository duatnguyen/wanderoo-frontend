        ...
        <div className="relative inline-flex items-center">
          ...
          <label
            ...
            className={cn(
              ...
              "select-none",
              checked
                ? "bg-[#E04D30] border-[#E04D30] shadow-sm"
                : "bg-white border-gray-300 hover:border-[#E04D30]/50",
              "focus-within:ring-2 focus-within:ring-[#E04D30]/20 focus-within:ring-offset-1",
              isPressed && "scale-90",
              "active:scale-95",

                ...
                <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-green-800">Trạng thái đơn: {currentOrder.status}</span>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-gray-50 border-gray-200">
                    <CardContent className="p-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-gray-800">Nguồn đơn: {currentOrder.source}</span>
                        </div>
                    </CardContent>
                </Card>
            </div>
                            ...
                            <tbody>
                                {currentOrder.items.map((item, index) => (
                                    <tr key={item.id} className="border-b">
                                        ...
                                        <td className="text-center py-4">{formatCurrency(item.price)}</td>

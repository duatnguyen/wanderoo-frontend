// src/pages/admin/AdminWarehouse.tsx
        ...
        <div className="text-center py-12">
          <div className="text-gray-400 mb-4">
            <svg className="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4.5 20.5V6l7.5-3 7.5 3v14.5" />
            </svg>
          </div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">Kho hàng trống</h3>
          <p className="text-gray-500">Thêm sản phẩm vào kho để bắt đầu theo dõi tồn kho.</p>
        </div>
      </div>
    </div>
  );

// src/pages/admin/AdminCreateShopWideVoucher.tsx
...
const AdminCreateShopWideVoucher: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            console.log('Creating shop-wide voucher:', formData);
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex items-center space-x-3">
                            <div className="bg-red-500 text-white px-4 py-2 rounded-lg flex items-center space-x-2">
                                ...
                                <span className="font-semibold text-lg">Voucher toàn shop</span>
                            </div>
                        </div>
...
export default AdminCreateShopWideVoucher;
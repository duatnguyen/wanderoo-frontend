...
export const getDistrictsByPath = async (
  provinceId: number
): Promise<DistrictResponse[]> => {
...
export const getWards = async (districtId: number): Promise<WardResponse[]> => {
  const response = await api.post<ApiResponse<WardResponse[]>>(
    "/api/shipping/wards",
...
export const getWardsByPath = async (
  districtId: number
...
export const calculateShippingFee = async (
  ...
  const response = await api.post<ApiResponse<ShippingFeeResponse>>(
...
export const getStations = async (
  ...
  const response = await api.post<ApiResponse<StationsResponse>>(
    "/api/shipping/stations",
    request
  );
  return response.data.data;
};
...
export const createShippingOrder = async (
  request: CreateGHNOrderRequest
): Promise<CreateShippingOrderResponse> => {
  const response = await api.post<ApiResponse<CreateShippingOrderResponse>>(
    "/api/shipping/orders",
    request
  );
  return response.data.data;
...
export const updateShippingOrder = async (
  ...
  const response = await api.post<ApiResponse<UpdateShippingOrderResponse>>(
    "/api/shipping/orders/update",
    request
  );
  return response.data.data;
};
...
export const updateShippingOrderByCode = async (
  ...
  const response = await api.put<ApiResponse<UpdateShippingOrderResponse>>(
    `/api/shipping/orders/${orderCode}`,
    request
  );
  return response.data.data;
};

export const getShippingOrderDetail = async (
  shippingOrderCode: string
): Promise<GHNOrderDetailResponse> => {
  const response = await api.get<ApiResponse<GHNOrderDetailResponse>>(
    `/api/shipping/orders/${shippingOrderCode}`
  );
  return response.data.data;
};
...
export const getOrderDetail = async (
  ...
  const response = await api.post<ApiResponse<GHNOrderDetailResponse>>(
    "/api/shipping/orders/detail",
    request
  );
  return response.data.data;
};

export const getOrderByClientCode = async (
  clientCode: string
): Promise<OrderByClientCodeResponse> => {
  const response = await api.post<ApiResponse<OrderByClientCodeResponse>>(
    "/api/shipping/orders/detail-by-client-code",
    {
...
export const getOrderByClientCodePath = async (
  clientCode: string
): Promise<OrderByClientCodeResponse> => {
  const response = await api.get<ApiResponse<OrderByClientCodeResponse>>(
    `/api/shipping/orders/detail-by-client-code/${clientCode}`
  );
  return response.data.data;
};
...
export const previewOrder = async (
  ...
  const response = await api.post<ApiResponse<PreviewOrderResponse>>(
    "/api/shipping/orders/preview",
    request
  );
  return response.data.data;
};
...
export const trackShippingOrder = async (
  shippingOrderCode: string
): Promise<GHNTrackingResponse> => {
  const response = await api.get<ApiResponse<GHNTrackingResponse>>(
    `/api/shipping/orders/${shippingOrderCode}/track`
  );
  return response.data.data;
};
...
export const getShippingStatus = async (
  ...
  const response = await api.get<ApiResponse<string>>(
    `/api/shipping/orders/${shippingOrderCode}/status`
  );
  return response.data.data;
};

export const trackByTrackingNumber = async (
...
export const cancelMultipleShippingOrders = async (
  request: CancelGHNOrderRequest
): Promise<{
...
export const getUserOrdersWithShipping = async (
  ...
  const response = await api.get<ApiResponse<any[]>>(
    `/api/shipping/user/${userId}/orders`,
    {
      params: { provider },
    }
  );
...
export const getAllOrdersForUser = async (userId: number): Promise<any[]> => {
  const response = await api.get<ApiResponse<any[]>>(
    `/api/shipping/debug/user/${userId}/all-orders`
  );
  return response.data.data;
};

// Print APIs
export const generatePrintToken = async (
  request: PrintOrderRequest
): Promise<GeneratePrintTokenResponse> => {
  const response = await api.post<ApiResponse<GeneratePrintTokenResponse>>(
    "/api/shipping/orders/print/token",
    request
  );
  return response.data.data;
};

export const printOrderA5 = async (
  request: PrintOrderRequest
): Promise<Blob> => {
...
export const printOrder80x80 = async (
  request: PrintOrderRequest
): Promise<Blob> => {
...
export const printOrder52x70 = async (
  request: PrintOrderRequest
): Promise<Blob> => {
...
export const printSingleOrder = async (
  ...
  const response = await api.get(
    `/api/shipping/orders/${orderCode}/print/${format}`,
    {
      responseType: "blob",
    }
  );
...
export const switchStatusToStoring = async (
  request: SwitchStatusRequest
): Promise<SwitchStatusResponse> => {
  const response = await api.post<ApiResponse<SwitchStatusResponse>>(
    "/api/shipping/switch-status/storing",
    request
  );
  return response.data.data;
};
...
// Webhook API
export const handleShippingWebhook = async (
  provider: string,
  payload: string
): Promise<string> => {

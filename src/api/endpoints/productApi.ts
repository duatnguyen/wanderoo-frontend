...
// Type aliases for page responses
type ProductPageResponse = PageResponse<ProductResponse>;
type VariantPageResponse = PageResponse<VariantResponse>;
...
export const getCategoryChildOptions = async (
    ...
    const response = await api.get<ApiResponse<CategoryChildPageResponse & {
        categoryChildResponseList?: CategoryChildPageResponse["content"]
    }>>(

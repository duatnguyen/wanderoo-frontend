...
export const getEmployees = async (params?: {
  ...
  const content = payload.content ?? payload.employees ?? [];
...
export const getEmployeeById = async (
  ...
  const response = await api.get<ApiResponse<EmployeeResponse>>(
    `/auth/v1/private/users/employees/${id}`
  );
  return response.data.data;
};
...
export const updateEmployeeAccount = async (
  ...
  const response = await api.put<ApiResponse<null>>(
    "/auth/v1/private/account/employee/upd",
    employeeData,
    {
      params: userType ? { userType } : undefined,
    }
...
export const disableAllEmployeeAccounts = async (
  selectData: SelectAllRequest
): Promise<ApiResponse<null>> => {
  const response = await api.delete<ApiResponse<null>>(
...
export const getCustomers = async (params?: {
  ...
  const content = payload.content ?? payload.customers ?? [];
...
export const getCustomerById = async (
  ...
  const response = await api.get<ApiResponse<CustomerResponse>>(
    `/auth/v1/private/users/customers/${id}`
  );
  return response.data.data;
};

export const createCustomer = async (
  customerData: CustomerCreationRequest
): Promise<ApiResponse<number>> => {
...
export const disableAllCustomerAccounts = async (
  selectData: SelectAllRequest
): Promise<ApiResponse<null>> => {
  const response = await api.delete<ApiResponse<null>>(
    "/auth/v1/private/account/customer/disable/all",
    {
      data: selectData,
    }
  );
...
export const getCustomerAddresses = async (
  ...
  const response = await api.get<ApiResponse<AddressPageResponse>>(
    `/auth/v1/private/users/customers/${customerId}/addresses`
  );
  return response.data.data;
};
...
export const getAdminAddresses = async (): Promise<AddressPageResponse> => {
  ...
  const response = await api.get<ApiResponse<AddressPageResponse>>(
    "/auth/v1/private/users/admin/address"
  );
...
export const deleteAdminAddress = async (
  addressId: number
): Promise<ApiResponse<null>> => {
  console.log("deleteAdminAddress API call:", addressId);
  const response = await api.delete<ApiResponse<null>>(
    `/auth/v1/private/users/admin/address/${addressId}`
  );
  console.log("deleteAdminAddress API response:", response.data);
  return response.data;
};

export const setDefaultAdminAddress = async (
  addressId: number
): Promise<ApiResponse<null>> => {
  console.log("setDefaultAdminAddress API call:", addressId);
  const response = await api.put<ApiResponse<null>>(
    `/auth/v1/private/users/admin/address/default?addressId=${addressId}`
  );
